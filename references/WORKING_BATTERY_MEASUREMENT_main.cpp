...
void setup() {
  ...
  Serial.println();
  Serial.println("=== TTGO T-SIM7000G Battery Voltage — Method #1 ===");
  Serial.printf("Pin: GPIO%d, ADC: 12-bit, Atten: 11 dB\n", PIN_ADC_BAT);
  Serial.println("Note: Prefer battery-only power during measurement; USB may affect readings on some boards.");
  Serial.println("Stabilizing for 2 s before first burst...");
  delay(2000);
